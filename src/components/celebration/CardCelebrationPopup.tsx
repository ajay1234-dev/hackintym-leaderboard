    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <motion.div
            initial={{ scale: animationConfig.scale[0], opacity: animationConfig.opacity[0], y: animationConfig.y[0] }}
            animate={{ 
          ...
          >
            ...
            >
              ...
              >
                <IconComponent className={`w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 ${rarityStyles.textColor} drop-shadow-[0_0_10px_currentColor]`} />
              </motion.div>

              {/* Card Details */}
              <div className="text-center">
                <div className={`text-[10px] sm:text-xs md:text-xs font-black uppercase tracking-widest ${rarityStyles.textColor} mb-1`}>
                  {card.type}
                </div>
